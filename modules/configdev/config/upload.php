...
$config['storage_path']['default'] =  '\\\\192.168.1.242/uploads/upload/yanzi/save/';
$config['storage_path']['save'] =  '\\\\192.168.1.242/uploads/upload/yanzi/save/';
$config['storage_path']['avatar'] =  '\\\\192.168.1.242/uploads/upload/yanzi/save/avatar';
$config['storage_path']['revision'] =  '\\\\192.168.1.242/uploads/upload/yanzi/revision/';
$config['local_storage_base']['default'] ="http://192.168.1.242/upload/yanzi/save/";
$config['local_storage_base']['save'] =   'http://192.168.1.242/upload/yanzi/save/';
$config['local_storage_base']['avatar'] =  'http://192.168.1.242/upload/yanzi/save/avatar';
$config['local_storage_base']['revision'] =   'http://192.168.1.242/upload/yanzi/revision/';
