...
$config['storage_path']['default'] =  '/data/beta/yanzi/img/upimg/save/';
$config['storage_path']['save'] =  '/data/beta/yanzi/img/upimg/save/';
$config['storage_path']['revision'] =  '/data/beta/yanzi/img/upimg/revision/';
$config['local_storage_base']['default'] ="http://imgditu.uutuu.com/img/upimg/save/";
$config['local_storage_base']['save'] =   'http://imgditu.uutuu.com/img/upimg/save/';
$config['local_storage_base']['revision'] =   'http://imgditu.uutuu.com/img/upimg/revision/';
