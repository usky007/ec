<?php
class Camp_Tourism_TweetComments_Model extends ORM_Cached
{
	protected $_primary_key = 'tweetComments_id';
	protected $_table_name = 'Camp_Tourism_TweetComments';
	protected $_table_names_plural = FALSE;
	protected $_created_column = array ("column" => 'created');
	protected $_belongs_to = array (
		"tweet_id" => array("model" => "camp_Tourism_tweet", "foreign_key" => 'tweet_id')
	);
	...
	public static function deploy() 
	{
		...
		try {
			$result = $db->query("
					CREATE TABLE IF NOT EXISTS `{$db->table_prefix()}Camp_Tourism_TweetComments` (
