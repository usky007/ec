<?php
class Camp_Tourism_Tweet_Model extends ORM_Cached
{
	protected $_primary_key = 'tweet_id';
	protected $_table_name = 'Camp_Tourism_Tweet';
	...
	public static function deploy() 
	{
		...
		try {
			$result = $db->query("
					CREATE TABLE IF NOT EXISTS `{$db->table_prefix()}Camp_Tourism_Tweet` (
	...
	public static function deploy_1() 
	{
		...
		try {
			...
			$preference->set('tourism-keywords', json_encode(array('#美国从心发现#')));
