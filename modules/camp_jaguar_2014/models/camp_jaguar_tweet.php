<?php
class Camp_Jaguar_Tweet_Model extends ORM_Cached
{
	protected $_primary_key = 'tweet_id';
	protected $_table_name = 'Camp_Jaguar_Tweet';
	...
	public static function deploy() 
	{
		...
		try {
			$result = $db->query("
					CREATE TABLE IF NOT EXISTS `{$db->table_prefix()}Camp_Jaguar_Tweet` (
	...
	public static function deploy_1() 
	{
		...
		try {
			...
			$preference->set('jaguar-keywords', json_encode(array('#探秘jaguarxf英伦创意#')));
