<?php
class Camp_Jaguar_Category_Model extends ORM_Cached
{
	protected $_primary_key = 'id';
	protected $_table_name = 'Camp_Jaguar_Category';
	...
	public function getTweets($keyword, $start, $range)
	{
		...
		$db = & Database::instance();
 		...
 		$db->join('Camp_Jaguar_Tweet', array($this->_table_name.'.tweet_id' => 'Camp_Jaguar_Tweet.tweet_id'), '', "INNER");
 		$db->where(array($this->_table_name.'.keyword' => $keyword));
 		$db->orderby('Camp_Jaguar_Tweet.created', 'desc');
 		$db->select('*');
