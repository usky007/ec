...
$config['offical_account'] = 'uutuu@uutuu.com';

$config['top_sync']['enabled'] = true;
$config['top_sync']['script'] = '/data/cron/yanzi/cp_top10_image.sh %s %s 2>&1';
...
$config['api']['version'] = "1.0.1";

$config['tracker']['google']['inpage_linkid'] = false;