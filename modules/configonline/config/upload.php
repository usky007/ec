...
$config['storage_path']['default'] =  '/data/online/yzimages/img/upimg/save/';
$config['storage_path']['save'] =  '/data/online/yzimages/img/upimg/save/';
$config['storage_path']['revision'] =  '/data/online/yzimages/img/upimg/revision/';
$config['local_storage_base']['default'] ="http://img.uutuu.cn/img/upimg/save/";
$config['local_storage_base']['save'] =   'http://img.uutuu.cn/img/upimg/save/';
$config['local_storage_base']['revision'] =   'http://img.uutuu.cn/img/upimg/revision/';
