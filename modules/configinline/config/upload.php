...
$config['storage_path']['default'] =  '/data/vhosts/yanzi/res/yz_img/save/';
$config['storage_path']['save'] =  '/data/vhosts/yanzi/res/yz_img/save/';
$config['storage_path']['revision'] =  '/data/vhosts/yanzi/res/yz_img/revision/';
$config['local_storage_base']['default'] ="http://yanzi.uutuu.com/res/yz_img/save/";
$config['local_storage_base']['save'] =   'http://yanzi.uutuu.com/res/yz_img/save/';
//$config['local_storage_base']['site'] =   'http://alpha-farm0.b0.upaiyun.com/';
$config['local_storage_base']['revision'] =   'http://yanzi.uutuu.com/res/yz_img/revision/';
