<?php
class Camp_Wa_TweetComments_Model extends ORM_Cached
{
	protected $_primary_key = 'tweetComments_id';
	protected $_table_name = 'Camp_Wa_TweetComments';
	...
	public static function deploy() 
	{
		...
		try {
			$result = $db->query("
					CREATE TABLE IF NOT EXISTS `{$db->table_prefix()}Camp_Wa_TweetComments` (
