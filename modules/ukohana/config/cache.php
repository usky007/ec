...
// use dbobj_[table_name] to control db record cache behavior
$config['dbobj_Dictionary'] = array
(
	'lifetime' => 3600,
	'manageable' => false	// AS the foundation of cache management, must be set to false.
);
$config['pinyin'] = array
(
	'lifetime' => 86400
