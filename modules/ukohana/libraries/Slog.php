...
class Slog {
	...
	public function add($domain=null,$url=null,$ip=null,$browse=null)
	{
		if(!$this->enable)
			return $this;

		$message = $this->_format($ip,$browse,$domain,$url);
	...
	private function _format($ip=null,$browse=null,$domain=null,$url=null)
	{
		$ip = !is_null($ip)? $ip : (isset($_SERVER['REMOTE_ADDR'])?$_SERVER['REMOTE_ADDR']:'0.0.0.0');
		$browse = !is_null($browse)? $browse : $_SERVER['HTTP_USER_AGENT'];
