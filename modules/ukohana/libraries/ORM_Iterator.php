...
*
* $Id: ORM_Iterator.php 329 2011-06-21 03:08:23Z zhangjyr $
*
* @package    ORM
* @author     Kohana Team
...
class ORM_Iterator_Core implements Iterator, ArrayAccess, Countable {
	...
	public function __construct(ORM $model, Database_Result $result)
	{
		...
		// Database result
		$this->result = $result->result(TRUE, $this->class_name);
	}
	...
	{
		return $this->result->result_array(NULL, $this->class_name);
	}
