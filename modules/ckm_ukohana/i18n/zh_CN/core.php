...
(
	...
	// 驱动
	'driver_implements'     => '驱动 %s 没有实现 %s 类所要求的 %s 接口',
	'driver_not_found'      => '没有找到驱动 %s，或驱动不适用于 %s 类',
	'class_not_found'		=> '没有找到 %s 类',
	...
	// UUTUU defined
	'misconfiguration'		=> 'Detect misconfiguration: no "%s" specified.',
	'invalid_parameter'     => '参数错误："%s", 方法：%s:%s',
	'missing_parameter'		=> '缺少参数："%s"',
	'method_unimplement'	=> '类 %s 的 %s 方法尚未实现',
	'method_unsupported'	=> '类 %s 不支持 %s 方法',
	'assert_failure'		=> '断言错误: %s'
);
