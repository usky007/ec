...
class Service_View extends View {
	...
	public function render($print = FALSE, $renderer = FALSE)
	{
		...
		// deal cross domain
		$origin = null;
		if (isset($_SERVER['HTTP_ORIGIN']) && url::is_trusted($_SERVER['HTTP_ORIGIN'], $origin) && !is_null($origin)) {
			// This is for the possible ie8/ie9 cross domain solution;
	...
	private function _format_json_result($result, &$headers) {
