...
class Preference_Dictionary_Driver implements Preference_Driver {
	...
	private $default_backend_model = 'Dicentry_Model';
	...
	public function __construct($params = null)
	{
		...
		if (isset($params['manual_update'])) {
			$this->manual_update = $params['manual_update'];
		}
		if (isset($params['model'])) {
			$this->default_backend_model = $params['model'];
		}
	}
	...
	public function get_backend()
	{
		if (is_null($this->backend)) {
			$model = $this->default_backend_model;
			$this->backend = new $model();
			assertion::is_true($this->backend instanceof Dicentry_Model, "'model' in parameters passed to Preference_Dictionary_Driver must be an extension of Dicentry_Model, given '{$this->default_backend_model}'");
		}
		$this->backend->clear();
		return $this->backend;
	}
