			...
			var initFunc=function(){
				var count=$(".hilton_ad_box .ad").length;
...
$(document).ready(function(){
		...
		$(".hilton_ad_box .tabs a").each(function(i){
			setTimeout(function(){
				$(".hilton_ad_box .tabs a").eq(i).css("background-position","bottom");
				setTimeout(function(){
					$(".hilton_ad_box .tabs a").eq(i).css("background-position","");
					setTimeout(function(){
							$(".hilton_ad_box .tabs a").eq(i).css("background-position","bottom");
							setTimeout(function(){
								$(".hilton_ad_box .tabs a").eq(i).css("background-position","");
	...
	//	var i=Math.floor(0+Math.random()*$(".hilton_ad_box .ad").length);
		//if($(".hilton_ad_box .tabs a:eq("+i+")").hasClass("current"))return false;
		
		//$(".hilton_ad_box .tabs a").css("background-position","bottom");
		//setTimeout(function(){
	//		$(".hilton_ad_box .tabs a").css("background-position","");
		//},1000);
