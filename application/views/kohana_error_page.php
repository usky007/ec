...
<body class="lang-en gecko win">
	<div class="bg">
		<div id="page" class="page-venue-index">
			...
			<p class="error"><?php echo html::specialchars($description); ?></p>
			<!-- page -->
	
		    <div class="main" style="height:auto; min-height:450px;">
				<div><code class="block"><?php echo html::specialchars($message)."（#{$code}）"; ?></code></div>
